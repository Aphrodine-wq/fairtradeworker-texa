...
export function KeyboardShortcuts({ user, onShortcut }: KeyboardShortcutsProps) {
  ...
  return (
    <Card className="fixed inset-4 z-50 overflow-auto border-2 border-black dark:border-white bg-white dark:bg-black">
      <CardHeader>
      ...
      <CardContent className="space-y-6">
        <div>
          ...
          <div className="grid grid-cols-2 gap-3">
            {navigation.map((s) => (
              <div key={s.key} className="flex items-center justify-between p-2 border-2 border-black dark:border-white">
