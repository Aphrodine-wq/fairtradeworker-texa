            ...
            {leaderboard.map((entry) => (
              ...
              >
                <div className="flex items-center gap-4 flex-1">
                  <div className="flex items-center justify-center w-10 h-10 border-2 border-black dark:border-white bg-white dark:bg-black font-bold text-black dark:text-white">
                    {entry.rank <= 3 ? (
                      entry.rank === 1 ? (
