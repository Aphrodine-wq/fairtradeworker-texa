    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "size-7 bg-white dark:bg-black p-0 opacity-100 hover:bg-black dark:hover:bg-white hover:text-white dark:hover:text-black"
        ),
        ...
        day_range_start:
          "day-range-start aria-selected:bg-black dark:aria-selected:bg-white aria-selected:text-white dark:aria-selected:text-black",
        day_range_end:
