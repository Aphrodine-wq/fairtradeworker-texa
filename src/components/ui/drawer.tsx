  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "group/drawer-content bg-white dark:bg-black fixed z-50 flex h-auto flex-col border border-black/20 dark:border-white/20 shadow-lg",
        ...
        {...props}
      >
        <div className="bg-black dark:bg-white mx-auto mt-4 hidden h-2 w-[100px] shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  )
...
function DrawerTitle({
  ...
  return (
    <DrawerPrimitive.Title
      ...
      className={cn("text-black dark:text-white font-semibold tracking-tight", className)}
      {...props}
    />
  )
}
