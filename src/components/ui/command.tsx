...
function Command({
  ...
  return (
    <CommandPrimitive
      data-slot="command"
      className={cn(
        "bg-white dark:bg-black text-black dark:text-white border-0 shadow-sm flex h-full w-full flex-col overflow-hidden rounded-lg shadow-sm",
        className
      )}
      {...props}
    />
...
function CommandSeparator({
  ...
  return (
    <CommandPrimitive.Separator
      ...
      className={cn("bg-black dark:bg-white -mx-1 h-[2px]", className)}
      {...props}
    />
  )
}
...
function CommandShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "text-black dark:text-white ml-auto text-xs font-mono tracking-widest",
        className
      )}
      {...props}
    />
