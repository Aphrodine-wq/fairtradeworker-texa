  ...
  return (
    <div className="space-y-6">
      ...
      {availableJobs.length > 0 && (
        <Card className="border-0 shadow-md hover:shadow-lg bg-white dark:bg-black shadow-sm">
          <CardHeader>
          ...
          <CardContent className="space-y-3">
            {availableJobs.slice(0, 3).map(job => (
              <div key={job.id} className="flex items-center justify-between p-3 bg-white dark:bg-black border-0 shadow-md hover:shadow-lg rounded-md shadow-sm font-mono">
