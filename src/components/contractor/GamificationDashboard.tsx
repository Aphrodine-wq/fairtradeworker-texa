      ...
      <Card glass={isPro}>
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            <div className="text-center p-4 bg-white dark:bg-black border-0 shadow-md hover:shadow-lg rounded-md shadow-sm font-mono">
                ...
                <Card className={`${achievement.unlocked ? 'bg-[#00FF00] dark:bg-[#00FF00]' : ''}`} glass={!achievement.unlocked && isPro}>
                  <CardContent className="p-4">
                    <div className="flex items-start gap-4">
                      <div className={`
                        p-3 rounded-md border-0 shadow-md hover:shadow-lg shadow-sm font-mono
