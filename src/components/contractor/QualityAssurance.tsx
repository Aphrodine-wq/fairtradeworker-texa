...
import { CheckCircle, Plus, Star, Warning, Camera, Bell } from "@phosphor-icons/react"
        ...
        <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                      ...
                      {(newInspection.items || []).length > 0 && (
                        <Card className="bg-white dark:bg-black border-0 shadow-md hover:shadow-lg p-4 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {inspections.map(inspection => (
              <Card
                key={inspection.id}
                className="bg-white dark:bg-black border-0 shadow-md hover:shadow-lg shadow-sm"
              >
                <CardHeader>
            ...
            {inspections.length === 0 && (
              <Card className="col-span-full bg-white dark:bg-black border-0 shadow-md hover:shadow-lg shadow-sm">
