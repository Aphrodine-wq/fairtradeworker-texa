...
export function CRMDashboard({ user }: CRMDashboardProps) {
  ...
  const getStatusColor = (status: CRMCustomer['status']) => {
    switch (status) {
      case 'active':
        return 'bg-white dark:bg-black text-black dark:text-white border-0 shadow-lg hover:shadow-xl'
      case 'lead':
        return 'bg-white dark:bg-black text-black dark:text-white border-0 shadow-lg hover:shadow-xl'
      case 'completed':
        return 'bg-white dark:bg-black text-black dark:text-white border-0 shadow-lg hover:shadow-xl'
    ...
    <div className="space-y-8">
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        {myCustomers.length > 0 && (
          <Card className="p-4 bg-white dark:bg-black border-0 shadow-lg hover:shadow-xl">
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1 relative">
                ...
                <Input
                  ...
                  className="pl-10 bg-white dark:bg-black text-black dark:text-white border-0 shadow-lg hover:shadow-xl"
                />
              </div>
              <Select value={statusFilter} onValueChange={setStatusFilter}>
                <SelectTrigger className="w-full md:w-[200px] bg-white dark:bg-black text-black dark:text-white border-0 shadow-lg hover:shadow-xl">
      ...
      {myCustomers.length === 0 ? (
        <Card className="max-w-2xl mx-auto bg-white dark:bg-black border-0 shadow-lg hover:shadow-xl">
          ...
          {filteredCustomers.length === 0 ? (
            ...
            <Dialog key={customer.id}>
              <DialogTrigger asChild>
                <Card
                  className="cursor-pointer hover:shadow-[6px_6px_0_#000] dark:hover:shadow-[6px_6px_0_#fff] hover:translate-y-[-4px] transition-all duration-200 bg-white dark:bg-black border-0 shadow-lg hover:shadow-xl"
                  onClick={() => {
              ...
              <DialogContent className="bg-white dark:bg-black border-0 shadow-lg hover:shadow-xl">
                <DialogHeader>
                ...
                <div className="space-y-4 py-4">
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2 p-3 bg-muted rounded-lg dark:bg-transparent dark:border-0 shadow-lg hover:shadow-xl">
                      {customer.invitedVia === 'email' ? (
                        <>
                  ...
                  <div className="space-y-2">
                    ...
                    {isEditingNotes ? (
                      ...
                      <div className="text-sm p-3 bg-muted rounded-lg min-h-[80px] dark:bg-transparent dark:border-0 shadow-lg hover:shadow-xl dark:text-white/80">
