        ...
        <CardContent className="space-y-4">
          ...
          {myCrew.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
              {myCrew.map((member) => (
                <div key={member.id} className="p-4 border-2 border-black dark:border-white">
      ...
      <Card glass={isPro}>
        ...
        <CardContent className="space-y-4">
          {activeJobs.length === 0 ? (
            ...
            activeJobs.map((job) => (
              <div key={job.id} className="p-4 border-2 border-black dark:border-white">
        ...
        <Card glass={isPro}>
          ...
          <CardContent className="space-y-4">
            {dispatches.map((dispatch) => {
              ...
              return (
                <div key={dispatch.id} className="p-4 border-2 border-black dark:border-white">
                  <div className="flex items-start justify-between mb-2">
                    <div>
                      <p className="font-semibold text-black dark:text-white">{job?.title}</p>
