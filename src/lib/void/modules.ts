...
export const MODULE_DEFINITIONS: Omit<VoidModule, 'enabled'>[] = [
  ...
  },
  {
    id: 'calendar',
    name: 'CALENDAR',
    description: 'Schedule Management - Calendar view and appointments',
    icon: () => null,
    component: () => null,
    windowId: 'calendar',
    category: 'productivity',
  },
  {
    id: 'notes',
    name: 'NOTES',
    description: 'Quick Notes - Notes and reminders',
    icon: () => null,
    component: () => null,
    windowId: 'notes',
    category: 'productivity',
  },
  {
    id: 'tasks',
    name: 'TASKS',
    description: 'Task Management - To-do lists and task tracking',
    icon: () => null,
    component: () => null,
    windowId: 'tasks',
    category: 'productivity',
